-- Migration 001: initial schema (wea)
-- Mirror of ../SCHEMA.sql at v1.2 (Aurora MySQL 8.0).
-- Idempotent: uses CREATE TABLE IF NOT EXISTS throughout.
-- Requires `?multiStatements=true` in the DSN.
--
-- When you edit ../SCHEMA.sql, you MUST also update this file. There's a
-- repo-level CI check (TODO) that diffs the two; keep them in lock-step.
...
CREATE TABLE IF NOT EXISTS rpc_endpoints (
    ...
    purpose                 VARCHAR(24)    NOT NULL DEFAULT 'read_write',
...
-- =====================================================================
-- 6. audit_log (partitioned by month)
-- =====================================================================
...
-- =====================================================================
-- 7. Seed RPC endpoints (idempotent)
-- =====================================================================
