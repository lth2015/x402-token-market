/**
 * Architecture breadcrumb — same component lives in both consoles, with
 * a different `current` prop. Visualises the 4-actor x402 chain and
 * highlights where the user currently is.
 *
 *   HABA  →  NetStars Gateway  →  Wea Facilitator  →  Solana
 *
 * Click any other node to jump to that console.
 */
"use client";
